...
//     useClickOutside(componentRef as React.RefObject<HTMLElement>, () => { setSuggestions([]); });
...
//         return (
//             <ul className="viking-suggestion-list" style={{ border: '1px solid #ccc', padding: 0, margin: 0 }}>
//                 {loading && <div className="suggestions-loading-icon">Loading...</div>}
